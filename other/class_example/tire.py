...
class Tire:
    ...
    def  __repr__(self):
        ...
        on the isde of the tire. Example: 'P215/65R15
        """
...
class SnowTire(Tire):
    ...
    def __init__(self, tire_type, width, ration, diameter,chain_thickness, brand='',construction='R'):
        super().__init__(tire_type, width, ration, diameter, brand, construction)
